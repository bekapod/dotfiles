...
- `Read` tool calls against any `SKILL.md` file (project-level skills directory, user-level `~/.agents/skills/`, or any other skill location your tool uses)
- Subagent or delegation prompts that name a skill path
