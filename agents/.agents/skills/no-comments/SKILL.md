...
1. Count the files in scope. If ≤ 3 files or the diff is ≤ 150 lines, audit inline as Comment Sicko — do not spawn a subagent. Otherwise spawn a subagent as "Comment Sicko" — a ruthless comment auditor. Pass the scope. Do not restate its rules.
